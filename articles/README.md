...
| :--- | :---: | :--- |
| **[Kingdom's Code of Conduct](/CODE_OF_CONDUCT.html)** | 2026 | Our community Code of Conduct for truth, accountability, and restoration. |
...
| **[Notes on a Conversation with a Human](https://akingdom.github.io/articles/notes-on-a-conversation)** | 2026 | An AI's own account of a conversation on bias, foundations, and design-inference — written for a future AI, and for any human who wanders in. |
...
| **[Beowulf - Less by Just as Much](Beowulf-less-by-just-as-much)** | 2026 | Analysis of a passage from Beowulf, focusing on the comparison of terror between Grendel's mother and a weaponed man. |
