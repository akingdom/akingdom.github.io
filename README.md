...
- **Technology**: From simple embedded computers to complex networks and systems, I’ve helped design and build solutions across the spectrum.
	...
	- **Read more**: [A standard way to coordinate local web apps](https://akingdom.github.io/articles/Unified_Local_Orchestration_Architecture.md) - Unified Local Orchestration Architecture
